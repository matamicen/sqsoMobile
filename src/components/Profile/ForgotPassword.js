      ...
      await Auth.forgotPassword(this.state.email.toLowerCase())
        ...
        .catch((err) => {
          ...
          if (err.code === 'LimitExceededException')
            this.setState({
              errormessage: I18n.t('forgotPasswordAttempts'),
            ...
            else errmess = I18n.t('forgotPasswordEmailAgain');
            this.setState({
          ...
          else crashlytics().recordError(new Error('Auth.forgotPassword_PRD'));
  ...
  sendNewPassword = async () => {
    ...
    if (await hasAPIConnection()) {
      ...
      if (this.state.newPassword.length < 6) {
        this.setState({
          errormessage: I18n.t('forgotPassword6CharactersPassword'),
          confirmationcodeError: 1,
          indicator: 0
        });
        this.error = true;
      ...
      if (this.state.code.length < 1) {
        this.setState({
          errormessage: I18n.t('forgotPasswordYouMustEnter'),
          confirmationcodeError: 1,
          indicator: 0
        });
        this.error = true;
        ...
        await Auth.forgotPasswordSubmit(
          ...
          .catch((err) => {
            ...
            if (err.code === 'CodeMismatchException')
              this.setState({
                errormessage: I18n.t('forgotPasswordCodeInvalid'),
                confirmationcodeError: 1,
                indicator: 0
              });
            ...
            if (err.code === 'ExpiredCodeException')
              this.setState({
                errormessage: I18n.t('forgotPasswordInvalidCodeProvided'),
                confirmationcodeError: 1,
                indicator: 0
              });
            ...
            if (__DEV__)
              crashlytics().recordError(
                new Error('Auth.forgotPasswordSubmit_DEV')
              );
            else
              crashlytics().recordError(
                new Error('Auth.forgotPasswordSubmit_PRD')
              );
          ...
          {this.state.indicatorQRA === 1 ? (
            ...
            <KeyboardAvoidingView
              ...
              <Text
                ...
                {I18n.t('forgotPasswordPassRecovery')}
              </Text>
              <TextInput
              ...
              <TouchableOpacity
                ...
                <Text style={styles.buttonText2}>
                  {I18n.t('forgotPasswordBackLogin')}
                </Text>
              </TouchableOpacity>
            </KeyboardAvoidingView>
          ) : (
          ...
          <Modal
            ...
            <View
              ...
              <Text style={{ color: '#999', fontSize: 20 }}>
                {I18n.t('forgotPasswordSuccesfull')}
              </Text>
              <View
                style={{
                  marginTop: 15,
                ...
                <TouchableOpacity onPress={() => this.closePasswordChanged()}>
                  <Text style={{ color: 'white', fontSize: 18 }}>
                    {I18n.t('forgotPasswordClosePasswordChange')}
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
