...
import { getQrasFromSearch, searchQrasLocal } from '../../actions';
    ...
    tabBarIcon: ({ tintColor }) => {
      ...
      return (
        <View
          ...
          />
          <Text style={{ fontSize: 9, marginTop: 3, marginLeft: 10 }}>
            {I18n.t('SearchTitle')}
          </Text>
        ...
        {!this.state.searching ? (
          <View style={{ flex: 0.06, alignItems: 'center' }}>
            <Text style={{ fontSize: 12, color: 'grey' }}>
              {I18n.t('SearchWeStartToSearch')}
            </Text>
            <Text style={{ fontSize: 12, color: 'grey' }}>
              {I18n.t('SearchAfter4Digit')}
            </Text>
          </View>
        ) : (
          <View style={{ flex: 0.06, alignItems: 'center' }}>
            <Text style={{ fontSize: 13, color: 'grey' }}>
              {I18n.t('SearchSearching')}
            </Text>
          </View>
        )}
