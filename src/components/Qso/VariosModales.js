        ...
        >
          ...
          >
            <View style={{ flex: 1, alignItems: "center" }}>
              ...
              <Text style={{ color: "#8BD8BD", fontSize: 17, padding: 5 , fontWeight: 'bold',  textAlign: "center"}}>{I18n.t("variosModWelcSendLicense1")}</Text>
              {/* <Text style={{ color: 'white', fontSize: 18, fontWeight: 'bold' }}> info@superqso.com </Text> */}
