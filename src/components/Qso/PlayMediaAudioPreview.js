      ...
      <View style={{ flexDirection: 'row'}}>
       ...
       <View  style={{ alignItems: 'center', width:200}}>
        {(this.state.showBuffering) &&
         ...
         <Text style={{ fontSize: 14, color: 'white'}}>  Buffering ...</Text>

        }
        {(this.state.showDuration) &&
          <Text style={{ fontSize: 14, color: 'white'}}> {this.state.minutes}:{this.state.secondsText} / {this.state.minutesDuration}:{this.state.secondsDuration}</Text>
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(PlayMediaAudioPreview);