...
import Video from 'react-native-video';
 ...
 class PlayMediaAudioPost extends React.PureComponent {
      ...
      <View style={{ flexDirection: 'row'}}>
          ...
          {(this.state.playingAudio===false) ?
           <TouchableOpacity  style={{}}  onPress={ () => this.PlayAudio() }>
                  ...
                  <Image source={require('../../images/playMedia.png')}  style={{width: 36, height: 36 } } 
               resizeMode="contain" />    
           ...
           <TouchableOpacity  style={{}}  onPress={ () => this.PauseAudio() }>
                  ...
                  <Image source={require('../../images/pauseMedia.png')}  style={{width: 36, height: 36 } } 
               resizeMode="contain" />    
           ...
           <TouchableOpacity  style={{marginLeft: 6 }}  onPress={ () => this.onEnd() }>
                  
                  <Image source={require('../../images/stopMedia.png')}  style={{width: 36, height: 36 } } 
               resizeMode="contain" />    
       ...
       <View  style={{ alignItems: 'flex-start' }}>
        {(this.state.showBuffering) &&
         ...
         <Text style={{ fontSize: 14, color: 'black'}}>  Buffering ...</Text>

        }
        {(this.state.showDuration) &&
          <Text style={{ fontSize: 14, color: 'black'}}> {this.state.minutes}:{this.state.secondsText} / {this.state.minutesDuration}:{this.state.secondsDuration}</Text>
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(PlayMediaAudioPost);