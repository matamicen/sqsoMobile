...
import {
    deletedFlag, deletePost, deleteQsoQra,
    followAdd,

    getUserInfo, QsoQraDelete,
  ...
  render() {
    ...
    return (
      <View>
        ...
        <TouchableOpacity
          style={{ marginLeft: 11 }}
          onPress={() => this.deleteCallSign(this.props.qra)}>
          <Image
            source={require('../../images/removecircle2.png')}
                ...
                {!this.props.deletedflag ? (
                  <View
                    ...
                    <Text style={{ color: 'white', fontSize: 16 }}>
                      ...
                      callsign. If you want to change the callsign, add the new
                      one first and then delete this one.
                    </Text>
                  </View>
                ) : (
                  <View
