...
import {
  ...
  deleteMedia, deleteMediaInMemory, deletePost,
...
class DeleteMedia extends Component {
  ...
  render() {
  //  console.log('RENDER Delete Media');
              ...
              {this.state.warningMessage ? (
                <View
                  ...
                  <Text
                    ...
                    {I18n.t('DeleteMediaWarning')}
                  </Text>
                  <Text style={{ color: 'white', fontSize: 16 }}>
                    {I18n.t('DeleteMediaTheentire1')} {this.props.desc}.{' '}
                    {I18n.t('DeleteMediaTheentire2')}
                  </Text>
                </View>
              ) : (
                <View
                  ...
                  <Image
                    style={{ width: 27, height: 27, marginBottom: 20 }}
                    resizeMethod="resize"
                  ...
                  <Text
                    ...
                    {this.props.desc === 'photo'
                      ? I18n.t('DeleteMediaAreYouSurePhoto')
                      : I18n.t('DeleteMediaAreYouSureAudio')}{' '}
                    {this.props.desc === 'photo'
                      ? I18n.t('DeleteMediaPhoto')
                      : I18n.t('DeleteMediaAudio')}
                    ?
                  </Text>
                </View>
              )}
