export default {
    ...
    MuestroYouCanPlay: "You can play the audio before confirm it",
    ...
    helpPublishFLDDAYMessage2: 'after that the post will be published automatically, then you can still editing the post and adding more audios & photos, it will be published automatically to the current post.',
