export default {
  ...
  variosMorePhotos: 'You can add another photo by pressing the photo icon.',
  variosDontShow: 'Do not show this message anymore',
  variosModNovideomp4:
  ...
  QsoTypeANYdescQAP: 'Post that you are calling CQ (Frequency and Mode should be in the photo or description)',
  QsoTypePOST: 'Generic',
  QsoTypeQAP: 'QAP',
  ...
  helpPublishPOSTfield1: 'Tip information:',
  helpPublishPOSTfield2:
    'All your followers will be notified that you are publishing this post.',
  ...
  helpPublishQAPtitle: 'How to publish a CQ?',
  helpPublishQAPMessage1:
    'In order to publish a CQ you should add an image/photo or video of the rig with the frequency and mode that you are calling CQ or add that info in the description.',
  helpPublishQAPMessage2: 'then you press PUBLISH.',
  helpPublishQAPfield1: 'Tip information:',
  helpPublishQAPfield2:
    'All your followers will be notified that you are calling CQ.',
  ...
  QsoHeaderHelpQAP: 'How to publish a CQ?',
  QsoDate: 'Date:',
  ...
  PUSH_NEWQAP_TITLE: '%{callsign} is calling CQ',
  PUSH_NEWQAP_MESSAGE: 'See more details here',
  PUSH_TAGYOUNEWQAP_TITLE: '%{callsign} tagged you in his CQ post',
  ...
  PUSH_REPOSTQAP_TITLE: '%{callsign} repost a CQ',
  ...
  NOTIF_ACTIVTYPE_12_QAP: '%{callsign} tagged %{refqra} in a CQ',
  NOTIF_ACTIVTYPE_12_QAPYOU: '%{callsign} tagged you in a CQ',
  NOTIF_ACTIVTYPE_12_FLDAY: '%{callsign} tagged %{refqra} in an activity',
  NOTIF_ACTIVTYPE_12_FLDDAYYOU: '%{callsign} tagged you in an activity',
  ...
  NOTIF_ACTIVTYPE_60:
    '%{callsign} listened a QSO on Band: %{band} Mode: %{mode}',
  NOTIF_ACTIVTYPE_61: '%{callsign} is calling CQ',
  NOTIF_ACTIVTYPE_62: '%{callsign} promoted an activity',
  ...
  NOTIF_ACTIVTYPE_66: '%{callsign} republished a CQ',
  ...
  notification: {
    ...
    sharedQAP: '{{QRA}} reposted a CQ',
    sharedFLDDAY: '{{QRA}} reposted an Activity',
  ...
  qso: {
    ...
    checkOutQAP: 'Checkout who is calling CQ...',
    checkOutFLDDAY: 'Checkout this activity...',
    add: 'Comment',
  ...
  qra: {
    ...
    blockMess2: 'We will not notify the user that you block it.',
    blockMess3: 'You can unlock it at any time from the profile menu',
