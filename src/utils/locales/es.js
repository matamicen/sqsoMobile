export default {
  ...
  QsoTypeANYdescQAP: 'Publica que estas llamando CQ (Informa frecuencia y modo en la foto o descripción)',
  ...
  QsoTypecannotchange3:
    'Lo que se puede cambiar siempre es QSO y Escucha entre si o Actividad, CQ y Otro entre si.',
  QsoTypeclose: 'Cerrar',
  ...
  helpPublishFLDDAYfield2:
    'La publicación le llegara a todos tus seguidores y cada uno de ellos que la RePublica hace que le llegue a sus respectivos seguidores, asi tu publicación se propaga.',
  helpPublishQAPtitle: '¿Como publicar un CQ?',
  helpPublishQAPMessage1:
    'Para publicar un CQ debes agregar una imagen/video del equipo con la con la frecuencia que vas a estar llamando CQ o escribir la frecuencia y modo en la descripción.',
  ...
  QsoHeaderHelpQAP: '¿Como publicar un CQ?',
  ...
  PUSH_NEWQAP_TITLE: '%{callsign} esta llamando CQ',
  PUSH_NEWQAP_MESSAGE: 'Mirá los detalles aquí',
  PUSH_TAGYOUNEWQAP_TITLE: '%{callsign} te etiquetó en su public. de CQ',
  ...
  PUSH_REPOSTQAP_TITLE: '%{callsign} republicó un CQ',
  ...
  NOTIF_ACTIVTYPE_12_QAP: '%{callsign} etiquetó a %{refqra} en un CQ',
  NOTIF_ACTIVTYPE_12_QAPYOU: '%{callsign} te etiquetó a tí en un CQ',
  ...
  NOTIF_ACTIVTYPE_60:
    '%{callsign} escuchó un QSO en Banda: %{band} Modo: %{mode}',
  NOTIF_ACTIVTYPE_61: '%{callsign} esta llamando CQ',
  ...
  NOTIF_ACTIVTYPE_66: '%{callsign} republicó un CQ',
  ...
  notification: {
    ...
    createdQAP: '{{QRA}} está llamando CQ',
  ...
  qso: {
    ...
    checkOutQAP: 'Mirá quien está llamando CQ...',
  ...
  qra: {
    ...
    blockTitle: 'Usuarios bloqueados',
    NoBlockUsers: 'No hay usuarios bloqueados',
    ...
    blockMess3: 'Puede desbloquearlo en cualquier momento desde el menu de Perfil.',
