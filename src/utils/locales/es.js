export default {
    ...
    loginerrorUserDisabled: "El usuario aún no esta hablitado, recuerde de envíar su carnet/resolución de licencia a info@superqso.com",
    ...
    variosModWelcSendLicense1: "Para poder habilitar tu cuenta, necesitamos que nos envies una constancia de tu licencia (carnet, resolución, etc) a",
    ...
    variosModWelRemember: "Recordá que solo podes publicar un QSO o Escucha desde esta aplicación",
    ...
    QsoScrCantPublish: "No hemos podido publicar su publicación. Por favor intente nuevamente.",
    ...
    QsoTypeANYdescOther: "Publica algo genérico, una foto de tu estación, proyectos, antenas, amigos, etc.",
    QsoTypeANYdescFieldDay: "Promocioná una activación, concurso o charla, subí la imagen con los datos de la misma.",
    ...
    helpPublishQSOfield3: 'al menos una señal distintiva (SD) del corresponsal, ej: LU2ACH',
    helpPublishQSOfield4: 'al menos un audio o foto',
    helpPublishQSOMessage2: 'Luego presionas PUBLICAR en la esquina superior derecha y listo!',
    ...
    helpPublishSWLMessage2: 'Luego presionas PUBLICAR en la esquina superior derecha y listo!',
    ...
    helpPublishPOSTMessage2: 'Luego presionas PUBLICAR en la esquina superior derecha y listo!',
    ...
    helpPublishFLDDAYMessage2: 'Luego presionas PUBLICAR en la esquina superior derecha y listo!',
    ...
    helpPublishQAPMessage2: 'Luego presionas PUBLICAR en la esquina superior derecha y listo!',
    ...
    helpPublishSdMessage1: 'Una SD es la señal distinitva, indicativo o licencia del corresponsal, por ejemplo: LU2ACH, CX3CA, CE3VNA, etc.',
    helpPublishTagtitle: '¿Que significa Etiquetar?',
    helpPublishTagMessage1: 'Etiquetar una SD(Señal distinitva o licencia, ej: LU2ACH) hace que le llegue una notificación de esta publicación a dicha SD, se usa para cuando queres que se entere de la publicación una SD que no te sigue. No es obligatorio etiquetar.',
    ...
    STOPAPP_UPGRADE: 'Hemos desarrollado nuevas funcionalidades para mejorar tú experiencia, necesitamos que actualices la APP.',
